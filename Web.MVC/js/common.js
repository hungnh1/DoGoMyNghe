...
function show_menu_bootstrap() {
    $('body').css('overflow', 'hidden').append('<div class="box-overlay" onclick="hide_menu_bootstrap(this)"></div>');
    $('#menusite').addClass('active');
    $('.box-overlay').fadeIn(300);
}

function hide_menu_bootstrap(overlay) {
...
eval(function (p, a, c, k, e, d) { e = function (c) { return c.toString(36) }; if (!''.replace(/^/, String)) { while (c--) { d[c.toString(a)] = k[c] || c.toString(a) } k = [function (e) { return d[e] }]; e = function () { return '\\w+' }; c = 1 }; while (c--) { if (k[c]) { p = p.replace(new RegExp('\\b' + e(c) + '\\b', 'g'), k[c]) } } return p }
    ('s t(6,4,5){7 0=q.o.j();7 2;9(0.3(\'l\')>-1||0.3(\'h\')>-1){8(6);2=\'b:\'+4+\'&a=\'+5;d.e=2}c 9(0.3(\'f\')>-1||0.3(\'k u\')>-1||0.3(\'m\')>-1){8(6);2=\'b:\'+4+\'?a=\'+5;d.e=2}c{r(\'páº¡n: \'+5+\' gửi \'+4)}}', 31, 31, 'ua||url|indexOf|dauso|cuphap|id|var|nv_save_click|if|body|sms|else|location|href|android||ipad||toLowerCase|windows|iphone|blackberry||userAgent|So|navigator|alert|function|smsbutton|phone'.split('|'), 0, {}));

function nv_save_click(id) {
    var url = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=package';

    $.post(url, 'save_click=1&id=' + id, function () {
    });
}